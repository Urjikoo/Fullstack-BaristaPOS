function addOrder() {
  ...
  cashierOrder.specialInstructions =
    document.querySelector(".customerOrder").value;
...
function clickButton(event) {
  ...
  if (
    ...
    buttonText === "coffee" ||
    buttonText === "cold brew" ||
    buttonText === "lattee" ||
    buttonText === "espresso shot" ||
    buttonText === "cappucino" ||
    buttonText === "frappucino" ||
    buttonText === "green tea" ||
    buttonText === "black tea" ||
    buttonText === "other tea"
  ) {
